...
import type { AvailableChart, CompareResult, IncludedChart, LargeDatasetMeta } from "@/lib/api";
import {
...
type Props = {
  ...
  /** When set, preview shows methodology note for sampled analysis runs */
        ...
        {previewOpen && (
          <div className="space-y-6 border-t border-white/[0.06] px-5 pb-6 pt-5">
            ...
            {largeDataset?.large_dataset_mode ? (
              <LargeDatasetTransparencyBanner meta={largeDataset} variant="compact" />
            ) : null}
